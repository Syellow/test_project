...
<body>
    ...
    ?>
      ...
      <?php        
                    ...
                    {
                        ?>
                        <tr onclick='location.href="Activity_page.php?activityid=<?php echo $row['AC_ID']?>"'> 
     <?php
                        ...
                        echo "<td>".$Overyet."</td>";
                        echo "<input type='hidden' name='AC_ID' id='AC_ID' value='".$row['AC_ID']."''/>";

                       if($row['ac_q_overyet']==1)
                        {
                                $query=" SELECT COUNT(U_ID) AS People FROM `ac_a_list` WHERE AC_ID=".$row['AC_ID']."";
                                $data=mysqli_query($con,$query)or die(mysqli_error()); 
