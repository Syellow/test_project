...
if($ynupdata == "udy")
{
	...
	{	
		...
		$url_path='http://fs.mis.kuas.edu.tw/~s1102137216/%E5%B0%88%E9%A1%8C/%E5%B0%88%E9%A1%8C%E6%A8%A1%E6%9D%BF/UpdateActivityIMG';
...
<script>
	alert("新增成功");
	location.href= ('activitylist.php?subjectid=<?php echo $ac_classkind?>'); 
</script>