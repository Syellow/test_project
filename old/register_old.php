...
<body>
  ...
  <div id="page-wrapper">
    ...
    <form class="form-horizontal" method="POST" action="registeredsucess.php">
            <div class="row">
                      <div class="col-sm-12">
                        <h1 class="page-header">
                            新用戶註冊 <small>您好，歡迎您使用  Friteach！</small>
                        </h1>
                        </div>
        <div class="row">
                <div class="col-lg-3"></div>
                    <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="U_Username" class="form-control" maxlength="15" id="U_Username" required="required" onkeyup="value=value.replace(/[\W]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="password" maxlength="15" id="U_Comfirm" name="U_Comfirm" required="required">
                                <p class="help-block">確保與您輸入的密碼一致</p>
                            </div>

                            <div class="form-group">
                                <label for="U_Email">電子郵件  ：</label>
                                <input class="form-control" name="U_Email" id="U_Email" required="required">
                                <p class="help-block"></p>
                            </div>

                            <div class="form-group">
                                <label for="U_Name">真實名字*  :</label>
                                <input class="form-control" class="form-control" id="U_Name" name="U_Name" required="required">
                                <p class="help-block"></p>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="U_Phone" class="form-control" maxlength="10" id="U_Phone" required="required" onkeyup="value=value.replace(/[^\d]/g,'')" />
                                <p class="help-block"></p>
                            </div>
    
                            <div class="form-group">
                                <label for="U_Specialty">專長   ：</label>
                                <input class="form-control" name="U_Specialty" class="form-control" maxlength="30" id="U_Specialty" required="required" />
